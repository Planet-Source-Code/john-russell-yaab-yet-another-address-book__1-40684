...
' Declared as Public setfrom frmAddress before calling this form
' So we can easily pass values
...
' When the form is unloaded, be sure to set the form to Nothing. This totally removes all references
' to and memory used by the form
